      ...
      <div className=" my-20">
        <div className="grid my-8 md:grid-cols-2  md:gap-x-10 justify-center items-center">
          ...
          <div className="md:order-1">
            ...
            Our vision at The Digital Loom Inc. is to be the unrivaled enabler of growth for organizations, regardless of size, by offering top-tier IT staffing and comprehensive IT-enabled services. We aim to be the preferred partner in digital transformation, technology integration, software development, and the creation of cutting-edge technology processes. Through our expertise in AI and ML, we envision creating an ecosystem where innovation thrives, empowering companies to achieve unparalleled success through optimized talent and transformative solutions.
