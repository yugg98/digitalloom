  ...
  return (
    <main>
      <div className="w-full bg-[url('/it.jpg')] bg-cover py-36">
        ...
        Explore the comprehensive solutions we offer in digital strategy development, needs assessment and gap analysis, and roadmap for digital transformation.
